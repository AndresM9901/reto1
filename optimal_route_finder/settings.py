...
SECRET_KEY = 'django-insecure-0#iafxp3-^1c@(mdtns1f5)s((ae!5vhdb7(*)4+v)@kv*8^ch'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR, 'data_loader/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
ACCOUNT_EMAIL_CONFIRMATION_TEMPLATE = 'account/confirmation_email.html'
